  ...
  <Card>
    ...
    <CardContent>
      <Grid container rowSpacing={{ xs: 1, md: 2 }} columnSpacing={{ xs: 2, md: 3 }}>
        <ResponseField label="Claim ID" value="123456789" sm={6} />
        <ResponseField label="Date of Service" value="12/24/2012 - 12/24/2012" sm={6} />
        <ResponseField label="Amount Billed" value="$XXXX.XX" sm={6} />
        <ResponseField label="Amount Paid" value="$XXXX.XX" sm={6} />
        <ResponseField
          label="Message"
